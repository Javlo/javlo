	...
	<form id="create-ticket" method="post" action="${info.currentURL}">
		...
		<div class="btn-group">
			<div class="_jv_btn-check">
				<input id="p1" type="radio" name="priority" value="0">
				<label for="p1">none</label>
			</div>
			<div class="_jv_btn-check">
				<input id="p1" type="radio" name="priority" value="1">
				<label for="p1">low</label>
			</div>
			<div class="_jv_btn-check">
				<input id="p1" type="radio" name="priority" value="2">
				<label for="p1">middle</label>
			</div>
			<div class="_jv_btn-check">
				<input id="p1" type="radio" name="priority" value="3">
				<label for="p1">high</label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="row">
				<c:forEach var="user" items="${ticketAvailableUsers}">
					<div class="col-xs-6">
						<label> <input type="checkbox" name="users" value="${user.login}" /> ${user.login}
						</label>
					</div>
				</c:forEach>
			</div>
