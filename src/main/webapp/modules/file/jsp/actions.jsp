...
<a class="action-button" href="${info.currentURL}?webaction=template.commit&webaction=browse&name=${param.name}&from-module=template"><span>${i18n.edit['template.action.commit']}</span></a>
<a class="action-button" href="${info.currentURL}?webaction=template.commitChildren&webaction=browse&name=${param.name}&from-module=template"><span>${i18n.edit['template.action.commit-children']}</span></a>
</c:if>
<div class="clear">&nbsp;</div>
