...
<form id="paypal-form" class="standard-form" action="${info.currentURL}" method="post">
	<fieldset>
		<legend>${network.name}</legend>
		<input type="hidden" name="webaction" value="updateEcom" />
		<input type="hidden" name="name" value="${ecom.name}" />
		<div class="line">
			<label for="client_id">client id</label>
			<input type="text" name="client_id" id="client_id" value="${ecom.appId}" />
		</div>
