...
<div class="login center-block">
	...
	<%if ( request.getParameter("j_username") == null  && request.getParameter("pwtoken") == null && request.getParameter("resetpwd") == null) {%><div class="message"><div class="alert alert-info"><%=i18nAccess.getViewText ( "login.intro" )%></div></div><%}
