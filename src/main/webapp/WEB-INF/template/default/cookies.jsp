...
<div id="cookies-message">	
	...
	<div class="actions">
		<form action="${info.currentURL}" method="post">
			...
			<c:if test="${not empty info.cookiesPolicyUrl}"><a class="btn btn-sm btn-secondary" target="_blank" href="${globalContext.cookiesPolicyUrl}">${i18n.view['global.more']}</a></c:if>
		</form>
	</div>	
</div>