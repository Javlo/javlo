...
//			out.println("</div>");
			...
			if (getVirtualStock(ctx) > getOffset(ctx)) {
				...
				out.println("<span class=\"buy\"><button class=\"btn btn-default btn-primary buy\" type=\"submit\" name=\"buy\"><svg sytle=\"vertical-align: baseline;\" xmlns=\"http://www.w3.org/2000/svg\" width=\"14\" height=\"14\" fill=\"currentColor\" class=\"bi bi-basket\" viewBox=\"0 0 16 16\">\r\n"
