...
public class StockvaultSharedContent extends SharedContent {
	
	private String remoteImageUrl;

	public StockvaultSharedContent(String id, Collection<ComponentBean> content) throws Exception {
		super(id, content);	
	}
	...
	public void loadContent(ContentContext ctx) {
		...
		if (content == null) {
			...
			String baseStaticFolder = URLHelper.mergePath(SHARED_CONTENT_FOLDER, "stockvault");		
