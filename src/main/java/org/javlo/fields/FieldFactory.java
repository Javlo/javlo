...
public class FieldFactory {
	...
	private static Field[] fields = new Field[] { new Field(), new FieldLargeText(), new FieldWysiwyg(), new FieldWysiwygWithTitle(), new FieldDescription(), new FieldDate(), new FieldAge(),new FieldFile(), new FieldList(), new OpenList(), new OpenMultiList(), new FieldMultiList(), new FieldImage(), new FieldExternalLink(), new FieldInternalLink(), new FieldEmail(), new FieldTextList(), new FieldBoolean(), new FieldNumber(), new Heading("h1"), new Heading("h2"), new Heading("h3"), new Heading("h4"), new Heading("h5"), new Heading("h6"), new DateOfPublication(), new EndDateOfPublication() };
