...
public class AdminAction extends AbstractModuleAction {
	...
	public static boolean updateGraphicCharter(ContentContext ctx, GlobalContext currentGlobalContext) throws IOException {
		...
		td.setPrimaryBackground(StringHelper.parseColor(requestService.getParameter("primaryBackground", "" + td.getPrimaryBackground())));
		...
		td.setSecondaryBackground(StringHelper.parseColor(requestService.getParameter("secondaryBackground", "" + td.getSecondaryBackground())));
