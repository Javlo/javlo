...
public class FotogrphSharedContent extends SharedContent {
	
	private String remoteImageUrl;

	public FotogrphSharedContent(String id, Collection<ComponentBean> content) throws Exception {		
		super(id, content);
	}
	...
	public void loadContent(ContentContext ctx) {
		...
		if (content == null) {
			...
			String baseStaticFolder = URLHelper.mergePath(SHARED_CONTENT_FOLDER, "fotogrph");		
