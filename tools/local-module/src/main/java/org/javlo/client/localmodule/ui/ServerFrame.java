...
public class ServerFrame extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		btnExtractData.setText(i18n.get("config.server.action.extract-data")); // NOI18N
	...
	private void btnExtractDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExtractDataActionPerformed
		String server = txtServerURL.getText();
		String title = ServerConfig.getLabelFromUrl(server);
		if (title == null) {
			JOptionPane.showMessageDialog(this,
					i18n.get("config.server.error.extract-data-failed.message"),
					i18n.get("config.server.error.extract-data-failed.title"),
					JOptionPane.ERROR_MESSAGE);
		} else {
			txtTitle.setText(title);
		}
		cmbType.setSelectedItem(server != null && server.indexOf("j_token=") > 0 ? ServerType.JAVLO2 : ServerType.OTHER);
