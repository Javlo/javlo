...
public class CreateMonthHereMacro extends AbstractMacro {
	...
	public String perform(ContentContext ctx, Map<String, Object> params) throws Exception {
		...
		if (currentPage.getParent() == null) {
			...
			/*
			 * GlobalContext globalContext = GlobalContext.getInstance(ctx.getRequest()); PersistenceService persistenceService = PersistenceService.getInstance(globalContext); persistenceService.store(ctx);
			 */
