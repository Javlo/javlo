...
<c:if test="${empty templateFactory && empty param.name && empty param.previewEdit}"><a class="action-button valid-all" href="${info.currentURL}?webaction=validate"><span>${i18n.edit['command.admin.template.all']}</span></a></c:if>
