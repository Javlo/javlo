...
/**
 * @author pvandermaesen help to translate array and other object structure
 */
public class I18NHelper {
	 ...
	 *            a list of keys
	 * @param prefix
	 *            the prefix of the translation key ( sp. : content.web )
	 * @param request
	 *            the current request for resource access
	 ...
	 * 
	 * @param globalContext
	 *            the context of current website
	 * @param session
	 *            user session
	 * @param keys
	 *            a list of keys
