...
async function callAction(webaction, params, file) {
...
server.registerTool("nav_remove", {
...
server.registerTool("nav_move", {
    ...
    const params = { path, parent };
    if (previousSibling)
        params.previousSibling = previousSibling;
    const data = await callAction("nav.move", params);
    return ok(data);
});
// ── Content (component) tools ─────────────────────────────────────────────────
server.registerTool("content_add", {
...
server.registerTool("content_remove", {
...
server.registerTool("content_move", {
...
server.registerTool("content_uploadFile", {
...
// ── Template tools ────────────────────────────────────────────────────────────
server.registerTool("template_upload", {
...
server.registerTool("template_commit", {
...
server.registerTool("template_commitAll", {
